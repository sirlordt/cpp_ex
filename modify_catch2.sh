...
echo "" >> "$TMP_FILE"
echo "// Signal handling code commented out to avoid conflicts with custom signal handlers" >> "$TMP_FILE"
echo "// This allows custom signal handlers to work properly" >> "$TMP_FILE"
echo "" >> "$TMP_FILE"
