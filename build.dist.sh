...
# 2. Default values
Container_Group="${Container_Group:-cpp_integration_test01}"
Container_User="${Container_User:-cpp_integration_test01}"
...
export Container_Bin_Name="cpp_integration_test01"
# Ensure Container_Bin_Path doesn't have a trailing slash to avoid double slashes
export Container_Bin_Path="/usr/local/bin/cpp_integration_test01"
...
if [ -z "$Container_Name" ]; then
    Container_Name="cpp_integration_test01"
